package com.illagu.attil.customviews.dotsloader.loaders
...
import com.illagu.attil.customviews.dotsloader.basicviews.CircleView
import com.illagu.attil.customviews.dotsloader.contracts.LoaderContract
...
class AllianceLoader : LinearLayout, LoaderContract {
    ...
    var thirdDotColor: Int = resources.getColor(
    ...
    override fun initAttributes(attrs: AttributeSet) {
        ...
        this.dotsRadius =
            typedArray.getDimensionPixelSize(R.styleable.AllianceLoader_alliance_dotsRadius, 50)

        this.distanceMultiplier =
            typedArray.getInteger(R.styleable.AllianceLoader_alliance_distanceMultiplier, 4)
        ...
        this.drawOnlyStroke =
            typedArray.getBoolean(R.styleable.AllianceLoader_alliance_drawOnlyStroke, false)
