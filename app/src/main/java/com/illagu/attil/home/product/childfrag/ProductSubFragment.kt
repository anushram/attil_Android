...
import com.illagu.attil.databinding.FragmentSubProductBinding
import com.illagu.attil.home.product.ProductsViewModel
import com.illagu.attil.home.product.VarietyListActivity
import com.illagu.attil.home.product.adapter.CategoryMainListAdapter
import com.illagu.attil.home.product.adapter.CategoryProductListAdapter
import com.illagu.attil.home.product.listener.CategoryMainListener
import com.illagu.attil.home.product.listener.CategoryProductListener
    ...
    private fun getCategories() {
        try {
            if (AppUtils.isConnectedToInternet(requireActivity())) {
                showProgressBar()
                val productsViewModel = ProductsViewModel(Application())
