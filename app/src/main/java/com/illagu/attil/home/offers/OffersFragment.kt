...
import com.illagu.attil.cart.CartItemActivity
import com.illagu.attil.customviews.GravitySnapHelper
import com.illagu.attil.databinding.FragmentOffersBinding
import com.illagu.attil.home.details.ItemDetailsActivity
import com.illagu.attil.home.offers.adapter.NormalOffersListAdapter
import com.illagu.attil.home.offers.adapter.TopOffersListAdapter
                ...
                if (obj.has("status") && obj.getBoolean("status")) {
                    if (obj.has("data") && !obj.isNull("data")) {
                        ...
                        for (i in 0 until dataArray.length()) {
                            ...
                            topOfferDto.sliderImage = sliderImageList
